...
def prove_in_model(formula, model):
    def prove_in_model_helper(formula: formula, model: dict):
        if is_variable(formula.root):
            ...
            # TODO here is the thing we need to think about. assume that &|FT are working in their stand-alone
            # versions. what we need to do is combine it in a smart way using task1 helper
