...
if __name__ == '__main__':
    test_from_infix(True)
    test_from_infix_all_operators(True)
    test_from_prefix(True)
    test_from_prefix_all_operators(True)
    test_infix(True)
    test_infix_all_operators(True)
    test_prefix(True)
    test_variables(True)
    test_variables_all_operators(True)